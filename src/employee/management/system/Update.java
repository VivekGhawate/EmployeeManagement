...
public class Update extends JFrame implements ActionListener{
    ...
    Update(String empId) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                lblname.setText(rs.getString("lname"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                conn conn = new conn();
                String query = "update employeedata set fname = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', education = '"+education+"', designation = '"+designation+"' where empId = '"+empId+"'";
